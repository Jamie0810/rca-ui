...
class SNDetailTestingData extends React.Component{
  state = {
    SNInformaion: []
  };

  componentDidMount() {
    getSNInformation(this.props.sn, 'test').then(SNInformaion => {
      this.setState({ 
...
export default withTranslation()(withLoading(SNDetailTestingData, true));
