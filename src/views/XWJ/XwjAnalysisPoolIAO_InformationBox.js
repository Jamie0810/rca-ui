...
class XwjAnalysisPoolIAO_InformationBox extends React.PureComponent {
  render() {
          ...
          <FormValueColumn>
            ...
            <BlockLabel>
              {t('analysis_set.capture.y_focus_range_template', {
                lower: statistic.boundary.testLower,
                upper: statistic.boundary.testUpper
              })}
            </BlockLabel>
            <BlockLabel>
...
export default withTranslation()(XwjAnalysisPoolIAO_InformationBox);
